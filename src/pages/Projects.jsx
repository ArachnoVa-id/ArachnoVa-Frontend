...
export default function ProjectsPage() {
  ...
  return (
    <>
      ...
      <section className="relative w-full bg-white-MainPage lg:pt-[5vw] pt-[22vw] lg:pb-[1vw] pb-[5vw] max-h-screen flex flex-col justify-center">
        ...
        <div className="flex flex-col gap-[0.15vw]">
