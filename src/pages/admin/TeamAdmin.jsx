        ...
        {members?.map((m, i) => (
          <div key={i} className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
            ...
            <div className="space-y-2">
              ...
              <input value={m.image || ""} onChange={(e) => update(i, "image", e.target.value)} placeholder="Image path (optional)" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm font-mono" />
