                ...
                <div className="flex flex-col items-center border-border relative lg:border-b-[0.052vw] lg:h-[11.719vw] lg:p-[1.458vw] lg:gap-[1.458vw] border-b-[0.233vw] h-[60.465vw] px-[4.651vw] py-[6.512vw] gap-[3.721vw]">
                  <div className="w-full h-full relative">
                    ...
                    <div className="absolute bottom-0 w-full flex justify-center">
                      <a href={plan.cta || "https://wa.me/6287882832538"} className="inline-block font-InterBold lg:text-[0.729vw] text-[2.5vw] text-neutral-a bg-gradient-to-r from-[#1AB0C8] to-[#179FB5] lg:px-[1.5vw] px-[4vw] lg:py-[0.5vw] py-[1.5vw] rounded-[0.3vw] hover:translate-y-[-0.15vw] transition-all duration-300 whitespace-nowrap">
