          ...
          <div data-aos="fade-up" className="flex bg-[#FAFDFF] border-[#E2E8F0] lg:border-[0.156vw] lg:rounded-[1.042vw] lg:shadow-[0_0.573vw_1.042vw_-0.521vw_rgba(0,0,0,0.25)] border-[0.465vw] rounded-[3.721vw] shadow-[0_1.395vw_4.651vw_-2.326vw_rgba(0,0,0,0.15)]">
            ...
            <div className="flex flex-col border-[#E2E8F0] lg:border-r-[0.052vw] lg:w-[18.75vw] border-r-[0.233vw] w-[30.698vw]">
              ...
              <div className="flex flex-col justify-center border-[#E2E8F0] lg:p-[1.667vw] lg:border-b-[0.052vw] lg:h-[6.406vw] p-[4.651vw] border-b-[0.233vw] h-[28.837vw]">
                <div className="font-InterBold text-transparent bg-clip-text bg-gradient-to-r from-[#0893D4] via-[#44C4D9] to-[#159E8D] lg:text-[1.25vw] text-[4.186vw]">
                  Harga
                </div>
              </div>
            ...
            {/* Plan columns */}
            {plans.map((plan, pi) => (
              <div key={pi} className={`flex flex-col border-[#E2E8F0] relative ${pi < plans.length - 1 ? "lg:border-r-[0.052vw] border-r-[0.233vw]" : ""} lg:w-[18.75vw] w-[31.628vw]`}>
                {/* Header */}
                <div className="flex flex-col items-center border-[#E2E8F0] relative lg:border-b-[0.052vw] lg:h-[11.719vw] lg:p-[1.458vw] lg:gap-[1.458vw] border-b-[0.233vw] h-[60.465vw] px-[4.651vw] py-[6.512vw] gap-[3.721vw]">
                  <div className="w-full h-full relative">
                    ...
                    <div className="absolute bottom-0 w-full flex justify-center">
                      <a href={plan.cta || "https://wa.me/6287882832538"} className="flex justify-center items-center bg-gradient-to-r from-[#1AB0C8] to-[#179FB5] hover:translate-y-[-0.417vw] hover:scale-[110%] transition-all duration-500 ease-in-out lg:h-[2.396vw] lg:w-[15.833vw] lg:rounded-[0.417vw] h-[9.302vw] w-[22.326vw] rounded-[1.86vw]">
                        <p className="font-InterBold text-neutral-a lg:text-[0.833vw] text-[3.256vw]">{plan.ctaText || "Pilih Paket"}</p>
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col justify-center items-center border-[#E2E8F0] lg:p-[1.667vw] lg:border-b-[0.052vw] lg:h-[6.406vw] border-b-[0.233vw] h-[28.837vw]">
                  <div className="font-InterBold text-transparent bg-clip-text bg-gradient-to-r from-[#0893D4] via-[#44C4D9] to-[#159E8D] lg:text-[1.458vw] text-[4.186vw]">
                    {plan.priceNote && <div className="font-InterSemibold text-neutral-d lg:text-[0.729vw] lg:leading-[200%] text-[2.791vw] leading-[125%]">{plan.priceNote}</div>}
                    {plan.price}
                  </div>
                </div>
