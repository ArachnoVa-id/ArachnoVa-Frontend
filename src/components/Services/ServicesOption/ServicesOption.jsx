    ...
    <section className="relative w-full lg:min-h-screen flex flex-col justify-center items-center bg-white-MainPage overflow-hidden lg:pt-[0.83rem] lg:pb-[1.0rem] pt-[2.23rem] pb-[3.72rem]">
      <div className="relative flex flex-col justify-center items-center text-black lg:gap-[0.5rem] gap-[0.89rem]">
        ...
        <div className="flex justify-start items-center bg-white-MainPage lg:w-auto lg:overflow-visible w-[14.51rem] overflow-x-scroll overflow-visible">
          <div data-aos="fade-up" className="flex bg-[#FAFDFF] border-[#E2E8F0] lg:border-[0.041rem] lg:rounded-[0.2rem] lg:shadow-[0_2px_4px_-2px_rgba(0,0,0,0.25)] border-[0.12rem] rounded-[0.6rem] shadow-[0_6px_20px_-10px_rgba(0,0,0,0.15)]">
            {/* Feature labels column */}
            <div className="flex flex-col border-[#E2E8F0] lg:border-r-[0.014rem] lg:w-[3.0rem] border-r-[0.06rem] w-[4.91rem]">
              <div className="flex flex-col justify-center items-start border-[#E2E8F0] lg:border-b-[0.014rem] lg:h-[1.88rem] lg:p-[0.27rem] lg:gap-[0.2rem] border-b-[0.06rem] h-[9.67rem] p-[0.74rem] gap-[0.6rem]">
              ...
              <div className="flex flex-col justify-center border-[#E2E8F0] lg:p-[0.27rem] lg:border-b-[0.014rem] lg:h-[1.02rem] p-[0.74rem] border-b-[0.06rem] h-[4.61rem]">
              ...
              {featureRows?.map((feature, i) => (
                <div key={i} className="flex flex-col justify-center border-[#E2E8F0] font-InterSemibold lg:p-[0.27rem] lg:border-b-[0.014rem] lg:h-[0.67rem] lg:text-[0.5rem] p-[0.74rem] border-b-[0.06rem] h-[2.98rem] text-[0.6rem]">
                  {feature}
                </div>
              ))}
            </div>
            ...
            {/* Plan columns */}
            {plans.map((plan, pi) => (
              <div key={pi} className={`flex flex-col border-[#E2E8F0] relative ${pi < plans.length - 1 ? "lg:border-r-[0.014rem] border-r-[0.06rem]" : ""} lg:w-[3.0rem] w-[5.06rem]`}>
                {/* Header */}
                <div className="flex flex-col items-center border-[#E2E8F0] relative lg:border-b-[0.014rem] lg:h-[1.88rem] lg:p-[0.23rem] lg:gap-[0.23rem] border-b-[0.06rem] h-[9.67rem] px-[0.74rem] py-[1.04rem] gap-[0.6rem]">
                  <div className="w-full h-full relative">
                    ...
                    <div className="absolute bottom-0 w-full flex justify-center">
                      <a href={plan.cta || "https://wa.me/6287882832538"} className="flex justify-center items-center bg-gradient-to-r from-[#1AB0C8] to-[#179FB5] hover:translate-y-[-2px] hover:scale-[110%] transition-all duration-500 ease-in-out lg:h-[0.38rem] lg:w-[2.53rem] lg:rounded-[0.2rem] h-[1.49rem] w-[3.57rem] rounded-[0.3rem]">
                ...
                {/* Price */}
                <div className="flex flex-col justify-center items-center border-[#E2E8F0] lg:p-[0.27rem] lg:border-b-[0.014rem] lg:h-[1.02rem] border-b-[0.06rem] h-[4.61rem]">
                  <div className="font-InterBold text-transparent bg-clip-text bg-gradient-to-r from-[#0893D4] via-[#44C4D9] to-[#159E8D] lg:text-[0.5rem] text-[0.67rem]">
                ...
                {featureRows?.map((feature, fi) => {
                  ...
                  return (
                    <div key={fi} className="flex flex-col justify-center items-center border-[#E2E8F0] font-InterSemibold lg:p-[0.27rem] lg:border-b-[0.014rem] lg:h-[0.67rem] lg:text-[0.5rem] border-b-[0.06rem] h-[2.98rem] text-[0.52rem] text-center">
