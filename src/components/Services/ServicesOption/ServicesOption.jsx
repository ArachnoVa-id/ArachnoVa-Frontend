            ...
            {plans.map((plan, pi) => (
              <div key={pi} className={`flex flex-col border-[#E2E8F0] relative ${pi < plans.length - 1 ? "lg:border-r-[0.06rem] border-r-[0.23rem]" : ""} lg:w-[18.8rem] w-[31.6rem]`}>
                ...
                {featureRows?.map((feature, fi) => {
                  ...
                  return (
                    <div key={fi} flex flex-col justify-center items-center border-[#E2E8F0] font-InterSemibold lg:p-[0.83rem] lg:border-b-[0.06rem] lg:min-h-[1.04rem] lg:text-[0.94rem] border-b-[0.23rem] h-[4.7rem] text-[3.3rem] text-center">
