  ...
  return (
    <div
      ...
      className={`flex justify-center items-center bg-[#FAFDFF] border-border 
                  ...
                  lg:flex-row lg:min-h-0 lg:px-[0.5rem] lg:py-[0.33rem]  lg:gap-[0.33rem] lg:rounded-[0.21rem] lg:border-[3px] lg:shadow-[0px_9px_20px_-3px_rgba(0,0,0,0.15)]
                  flex-col min-h-0 px-[0.89rem] py-[0.89rem] gap-[0.74rem] rounded-[0.6rem] border-[9px] shadow-[0px_9px_89px_-22px_rgba(0,0,0,0.15)]`}
    >
      <div
      ...
      >
        ...
        <div
          className="flex justify-center items-center bg-[#FBFCFD] border-border
                     lg:w-[5.12rem] lg:h-[2.98rem] lg:rounded-[0.2rem] lg:border-[3px] lg:shadow-[0px_4px_40px_-5px_rgba(0,0,0,0.15)
                     w-[11.24rem] h-[6.4rem] rounded-[0.37rem] border-[7px] shadow-[0px_18px_179px_-22px_rgba(0,0,0,0.15)"
        >
          <Swiper
            className="overflow-hidden border-border 
                       lg:w-[4.9rem] lg:rounded-[0.2rem] lg:border-[2px]
                       w-[10.72rem] aspect-[1920/980] rounded-[0.3rem] border-[4px]"
            slidesPerView={1}
            spaceBetween={5}
