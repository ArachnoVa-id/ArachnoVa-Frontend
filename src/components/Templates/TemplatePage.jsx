          ...
          >
            <div
              ...
              className="w-full flex flex-col justify-center items-center bg-gradient-to-r from-[#76BDE4] to-[#79CACA]
                         lg:p-[0.2rem] lg:h-[0.8rem] lg:min-h-0 lg:rounded-[0.2rem] lg:shadow-[0_1px_4px_-0px_rgba(0,0,0,0.15)]
                         p-[0.2rem] min-h-[2.75rem] rounded-[0.45rem] shadow-[0_4px_20px_-1px_rgba(0,0,0,0.15)]"
