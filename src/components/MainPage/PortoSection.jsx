        ...
        <div className="flex flex-row items-start gap-x-[0.48rem] w-[12.8rem]">
            ...
            {productTypes.map((pt) => {
              ...
              return (
                <div
                  ...
                  className={`group w-full lg:h-[1.1rem] flex flex-row lg:p-[0.2rem] gap-x-[0.2rem] rounded-[0.2rem] cursor-pointer z-50 border-[2px] transition-all duration-300 ${
          ...
          <div className="flex-1 relative">
            ...
            {currentProject?.imageMobile && (
              <div className="bg-border absolute aspect-[303/514] z-[3] w-[2.52rem] p-[4px] shadow-2xl rounded-[0.2rem] -bottom-[4vh] -right-[0.64rem] flex flex-col">
                <div className="relative w-full h-full bg-white rounded-[0.2rem] p-[10px] group">
                  ...
                  <div className="absolute top-0 left-0 w-full h-full p-[10px] pointer-events-none">
