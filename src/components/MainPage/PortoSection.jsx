...
export default function PortoSection({ projects }) {
  ...
  return (
    <section className="w-full lg:aspect-[1920/1312] max-lg:aspect-[430/1101] relative flex flex-row justify-center items-center bg-white-MainPage gap-y-[1.82rem]">
      {/* Desktop */}
      <div className="flex flex-col justify-center items-center max-lg:hidden w-full lg:pt-[4.4rem]">
        <div className="text-neutral-g text-[2.0rem] font-SourceSansProBold flex justify-center">
          Our Tractions
        </div>
        <p className="text-neutral-e w-[50.8rem] text-center text-[0.88rem] font-SourceSansProSemibold mt-[0.66rem] mb-[1.82rem]">
        ...
        <div className="flex flex-row items-start gap-x-[2.6rem] w-[70.0rem]">
          {/* Left: Product type cards */}
          <div className="flex flex-col gap-[0.88rem] w-[28.0rem]">
            {productTypes.map((pt) => {
              ...
              return (
                <div
                  ...
                  className={`group w-full lg:h-[6.0rem] flex flex-row lg:p-[1.09rem] gap-x-[0.91rem] rounded-[0.64rem] cursor-pointer z-50 border-[0.11rem] transition-all duration-300 ${
                    isActive ? "border-LightBlue-c shadow-md" : "border-border bg-white hover:shadow-sm"
                  }`}
                >
                  <div className="flex flex-col gap-y-[0.41rem] flex-1 justify-center">
                    <p className={`font-SourceSansProBold lg:text-[1.28rem] transition-all duration-500 ${
                      isActive ? "bg-clip-text text-transparent bg-gradient-to-r from-[#1AB0C8] via-[#84D4E1] to-[#179FB5]" : "text-neutral-g"
                    }`}>
                      {pt.label}
                    </p>
                    <p className="font-SourceSansProSemibold lg:text-[0.73rem] text-neutral-d">
          ...
          <div className="flex-1 relative">
            {currentProject && (
              <div data-aos="fade-left" className="bg-border p-[0.18rem] rounded-[0.68rem] group">
                <div className="aspect-[1008/588] w-full p-[0.88rem] bg-[#FBFCFD] flex flex-col shadow-2xl rounded-[0.68rem]">
            ...
            {currentProject?.imageMobile && (
              <div className="bg-border absolute aspect-[303/514] z-[3] w-[13.8rem] p-[0.18rem] shadow-2xl rounded-[0.46rem] -bottom-[4vh] -right-[3.5rem] flex flex-col">
        ...
        <a
          href="/projects"
          className="flex flex-row justify-center items-center w-[8.6rem] gap-x-[0.23rem] mt-[4.0rem] aspect-[188/48] bg-transparent rounded-[0.36rem] hover:bg-[#5AB0BB]/20 hover:scale-[102%] transition-all duration-700 ease-in-out"
        >
      ...
      {/* Mobile */}
      <div className="flex flex-col justify-center items-center lg:hidden w-full pt-[21.9rem] pb-[8.8rem] px-[4.9rem]">
        <div className="text-neutral-g text-[7.0rem] font-SourceSansProBold text-center">Our Tractions</div>
        <p className="text-neutral-e text-[2.6rem] text-center font-SourceSansProSemibold my-[2.6rem]">
          ArachnoVa telah berpengalaman dalam pembuatan website mencakup aspek Frontend, Backend, dan desain UI.
        </p>

        <div className="flex flex-wrap gap-[1.75rem] mb-[4.4rem] justify-center">
          {productTypes.map((pt) => (
            <button
              key={pt.key}
              onClick={() => setActive(pt.key)}
              className={`px-[3.5rem] py-[1.75rem] rounded-[1.75rem] text-[2.6rem] font-InterBold transition-all ${
        ...
        {currentProject && (
          <div className="bg-border p-[0.44rem] rounded-[1.56rem] shadow-2xl w-full">
            <div className="w-full aspect-[390/228] bg-transparent p-[1.93rem] bg-[#FBFCFD] rounded-[1.56rem] flex flex-col overflow-y-scroll no-scrollbar">
        ...
        <a href="/projects" className="flex flex-row justify-center items-center gap-x-[1.75rem] mt-[7.0rem]">
          <p className="font-InterBold text-[3.1rem] bg-clip-text text-transparent bg-gradient-to-r from-[#1AB0C8] via-[#84D4E1] to-[#179FB5]">
            More Projects
          </p>
          <FaArrowRight className="text-[#24AAA7] w-[3.5rem]" />
        </a>
      </div>
    </section>
  );
