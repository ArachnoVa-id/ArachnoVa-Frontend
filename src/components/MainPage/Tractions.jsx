        ...
        <div className="flex flex-col lg:gap-[0.2rem] gap-[0.6rem] w-full">
          {tractions.map((item, i) => (
            <div
              ...
              className="group lg:w-full lg:h-[1.1rem] w-full h-auto flex flex-row lg:p-[0.2rem] p-[0.56rem] gap-x-[0.2rem] rounded-[0.2rem] lg:cursor-pointer z-50 border-[2px] border-border bg-white hover:shadow-md transition-all duration-300"
            >
