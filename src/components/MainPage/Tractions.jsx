...
const tractions = [
  ...
  },
  {
    ...
    link: "/services",
    gradient: "from-[#2EC1D9] to-[#179FB5]",
  },
  {
    title: "WhatsApp Apps",
    ...
    link: "/services",
    gradient: "from-[#0893D4] to-[#159E8D]",
  },
];
        ...
        <div className="grid lg:grid-cols-3 gap-[1.5vw] lg:gap-[2.083vw] w-full">
          {tractions.map((item, i) => (
            <div
              ...
              className="bg-white rounded-xl border border-[#E2E8F0] lg:p-[2.083vw] p-[5.581vw] shadow-sm hover:shadow-lg transition-all duration-500 hover:-translate-y-[0.5vw] group"
            >
              ...
              <p className="font-InterSemibold lg:text-[0.833vw] text-[2.791vw] text-LightBlue-d mb-[0.8vw]">
                {item.subtitle}
              </p>
              ...
              <a
                href={item.link}
                className="inline-block mt-[1.2vw] font-InterBold lg:text-[0.833vw] text-[2.791vw] text-LightBlue-c hover:text-LightBlue-e transition-colors"
              >
                Learn more →
              </a>
            </div>
