			...
			<section className="relative w-full lg:min-h-[5.3rem] min-h-[25.3rem] flex flex-col justify-center items-center bg-white-MainPage lg:gap-y-[0.33rem] gap-y-[0.89rem] overflow-hidden">
				<div className="w-fit flex lg:flex-row flex-col justify-center items-center lg:gap-x-[0.53rem] gap-y-[0.89rem]">
					<div
						data-aos="fade-right"
						className={
							"flex flex-col justify-center items-center lg:w-[5.07rem] w-[14.51rem] aspect-[390/224] lg:aspect-[608/316] lg:rounded-[0.2rem] rounded-[0.6rem] border-solid lg:border-[0.041rem] border-[0.18rem] border-[#76BDE4] gap-y-[0.29rem] " +
							styles.BoxLeft
						}
					>
					...
					<div
						data-aos="fade-left"
						className={
							"flex flex-col justify-center items-center lg:w-[5.07rem] w-[14.51rem] aspect-[390/224] lg:aspect-[608/316] lg:rounded-[0.2rem] rounded-[0.6rem] lg:border-[0.041rem] border-[0.18rem] border-solid border-[#52CEE0] gap-y-[0.2rem] " +
							styles.BoxRight
						}
					>
						<h1 className="font-SourceSansProBold lg:text-[0.5rem] text-[0.97rem] text-neutral-g">
