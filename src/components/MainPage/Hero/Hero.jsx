    ...
    <section className="w-full min-h-screen relative bg-white-MainPage overflow-hidden flex flex-row justify-center items-center">
      ...
      <div className="text-black flex gap-x-[1.28rem] max-lg:hidden z-[2]">
        <div className="flex flex-col justify-center scale-[1.2]">
          ...
          <div className="text-neutral-g font-SourceSansProBold text-[0.5rem]/[48px]">
          ...
          <div className="py-[2vh] flex gap-[0.2rem]">
            <a
              ...
              className="aspect-[167/46] w-[1.39rem] rounded-[0.2rem] bg-gradient-to-r from-[#1AB0C8] to-[#179FB5] font-InterBold text-white text-[0.5rem] flex justify-center items-center hover:translate-y-[-4px] transition-all duration-500 ease-in-out "
            >
              Start Your Project
            </a>
            <a
              href="/services"
              className="aspect-[197/48] w-[1.64rem] rounded-[0.2rem] bg-transparent text-[0.5rem] flex justify-center items-center hover:translate-y-[-4px] transition-all duration-500 ease-in-out hover:bg-[#cae8ee] "
            >
        ...
        <div className="aspect-[537/366] w-[4.48rem] border-2 border-[#F1F5F9] rounded-[0.2rem]  relative font-ConsolasRegular ">
          ...
          <div className="px-[0.2rem] py-[0.32rem] text-[0.5rem]/[22px] relative">
            <Image
              alt=""
              src="/image/Hero/3ColorButton.png"
              className="w-[0.48rem] h-[0.2rem] top-[0.2rem] left-[0.2rem] absolute"
      ...
      >
        ...
        <div className="text-neutral-g items-center justify-center font-SourceSansProBold text-[0.5rem]/[115px]">
        ...
        <div className="flex flex-col justify-center items-center text-[0.8rem]/[96px] pt-[0.64rem] text-neutral-e font-SourceSansProSemibold ">
        ...
        <a
          href="https://wa.me/6287882832538"
          className="w-[12.8rem] h-[1.28rem] mt-[0.64rem] my-[0.4rem] bg-gradient-to-r from-[#1AB0C8] to-[#179FB5] font-InterBold text-white rounded-md text-[0.5rem] flex justify-center items-center hover:translate-y-[-4px] transition-all duration-500 ease-in-out "
        >
          Start Your Project
        </a>
        <a href="/services" className="w-[12.8rem] h-[1.28rem] bg-transparent mb-[0.4rem] rounded-md text-[0.5rem] flex justify-center items-center hover:translate-y-[-4px] transition-all duration-500 ease-in-out hover:bg-[#cae8ee] ">
          <div className="bg-clip-text text-transparent bg-gradient-to-r from-[#1AB0C8] to-[#179FB5] font-InterBold">
            Discover Our Services
          </div>
        </a>
        ...
        <div className="bg-white opacity-90 w-[12.8rem] h-[9.6rem] rounded-lg border-2 border-[#F1F5F9]  relative font-ConsolasRegular ">
          <div className="absolute w-[9.6rem] h-[2.08rem]  bg-white opacity-90 rounded-md -bottom-[0.96rem] -right-[0.64rem] text-[0.5rem] border-2 border-border font-ConsolasBold  ">
            <Image
              ...
              height={100}
            />
            <div className="flex items-center text-[0.5rem] gap-x-[1px] pt-[0.8rem] whitespace-nowrap ml-[0.32rem]">
              <TerminalTyper speed={80} />
            </div>
          </div>
          <div className="px-[0.2rem] py-[0.64rem] text-[0.5rem]/[77px] relative ">
            <Image
              alt=""
              src="/image/Hero/3ColorButton.png"
