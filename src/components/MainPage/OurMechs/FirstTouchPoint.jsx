    ...
    <>
      ...
      >
        ...
        <Content
          ...
          Icon={
            <>
              <IoCall size="20px" className="text-[#1AB0C8]" />
            </>
          }
        ...
        <Content
          ...
          Icon={<IoChatbubbles size="20px" className="text-[#1AB0C8]" />}
        ...
        <Content
          ...
          Icon={<IoFolder size="20px" className="text-[#1AB0C8]" />}
      ...
      >
        <Content
          ...
          Icon={
            <>
              <IoCall size="80px" className="text-[#1AB0C8]" />
            </>
          }
        />
        <Content
          ...
          Icon={<IoChatbubbles size="80px" className="text-[#1AB0C8]" />}
          Variant="Left"
        />
        <Content
          Title="Pre-Execution"
          ...
          Icon={<IoFolder size="80px" className="text-[#1AB0C8]" />}
        />
      </div>
    </>
  );
