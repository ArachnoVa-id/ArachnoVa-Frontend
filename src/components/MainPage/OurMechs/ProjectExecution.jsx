    ...
    <>
      ...
      >
        ...
        <Content
          ...
          Icon={
            <>
              <IoIosPeople size="30px" className="text-[#1AB0C8]" />
            </>
          }
        ...
        <Content
          ...
          Icon={<IoIosArchive size="20px" className="text-[#1AB0C8]" />}
        ...
        <Content
          ...
          Icon={<IoSettings size="24px" className="text-[#1AB0C8]" />}
      ...
      <div className="w-fit h-[23.0rem] flex lg:hidden flex-col justify-between" data-aos="fade-right">
        ...
        <Content
          ...
          Icon={
            <>
              <IoIosPeople size="147px" className="text-[#1AB0C8]" />
            </>
          }
          Variant="Left"
        />
        <Content
          ...
          Icon={<IoIosArchive size="112px" className="text-[#1AB0C8]" />}
        />
        <Content
          Title="Production"
          List={
          ...
          Icon={<IoSettings size="107px" className="text-[#1AB0C8]" />}
          Variant="Left"
        />
      </div>
    </>
