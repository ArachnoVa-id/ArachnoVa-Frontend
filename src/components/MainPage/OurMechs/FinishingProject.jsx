    ...
    <>
      ...
      >
        ...
        <Content
          ...
          Icon={<BsBoxFill size="20px" className="text-[#1AB0C8]" />}
        ...
        <Content
          ...
          Icon={<FaLaptopCode size="20px" className="text-[#1AB0C8]" />}
      ...
      >
        ...
        <Content
          ...
          Icon={<BsBoxFill size="107px" className="text-[#1AB0C8]" />}
          Variant="Left"
        />
        <Content
          Title="Maintenance"
          ...
          Icon={<FaLaptopCode size="107px" className="text-[#1AB0C8]" />}
        />
      </div>
    </>
  );
