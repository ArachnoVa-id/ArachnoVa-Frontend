...
const Content = ({ Title, Icon, List, Variant, Position }) => {
  return (
    <div
      className={`${Position} lg:w-[2.92rem] lg:h-[1.85rem] w-[11.65rem] h-[6.51rem] flex flex-col items-center border-solid lg:p-0 px-[0.74rem] pt-[0.56rem] lg:rounded-[0.2rem] rounded-[0.6rem] lg:border-[2px] border-[9px] border-white z-[10]`}
      style={{
