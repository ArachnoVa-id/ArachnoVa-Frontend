const ContentHeaderRight = ({ Title, Icon }) => {
  return (
    <div className="lg:w-[clamp(2.57rem,16.042vw,23.1rem)] w-full flex flex-row justify-between items-center lg:mt-[clamp(0.2rem,0.781vw,1.12rem)]">
      ...
      <p className="font-SourceSansProBold text-neutral-g lg:text-[clamp(0.5rem,1.25vw,1.8rem)] text-[clamp(0.74rem,4.651vw,6.7rem)] lg:ml-[clamp(0.34rem,2.125vw,3.06rem)] ml-[clamp(1.43rem,8.926vw,12.85rem)]">
        {Title}
      </p>
      {Icon}
    </div>
