	...
	return (
		...
		>
			...
			<div className="flex flex-col gap-y-[0.469vw]">
				...
				<p className="lg:group-hover:bg-clip-text lg:group-hover:text-transparent lg:group-hover:bg-gradient-to-r lg:group-hover:from-[#7C3AED] lg:group-hover:via-[#A78BFA] lg:group-hover:to-[#6D28D9] transition-all duration-500 ease-in-out font-SourceSansProBold lg:text-[1.458vw] text-[4.651vw]/[6.977vw] text-neutral-g lg:leading-[1.563vw]">
					{Title}
				</p>
