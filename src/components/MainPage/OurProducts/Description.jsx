...
const Description = ({ Title, Description, Variant, href }) => {
	...
	const ButtonMobile = ({ href }) => {
		return (
			<a
				href={href}
				className="w-[12.47rem] aspect-[335/40] rounded-[0.3rem] flex lg:hidden items-center justify-center bg-gradient-to-br from-[#1AB0C8] to-[#179FB5] hover:translate-y-[-4px] transition-all duration-500 ease-in-out"
			>
