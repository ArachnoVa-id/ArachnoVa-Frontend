	...
	return (
		<>
			...
			>
				...
				/>
				<div
					className="flex justify-center items-center lg:w-[5.72rem] w-[12.65rem] lg:h-[3.33rem] h-[7.29rem] bg-[#FBFCFD] lg:rounded-[0.2rem] rounded-[0.37rem] border-solid border-border lg:border-[3px] border-[7px]"
