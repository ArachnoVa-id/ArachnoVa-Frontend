...
const NavItemMobile = ({ href }) => {
	return (
		...
		>
			...
			<a
				href={href}
				className="w-[3.42rem] h-[1.49rem] rounded-[0.3rem] flex items-center justify-center bg-gradient-to-br from-[#1AB0C8] to-[#179FB5] hover:translate-y-[-1px] transition-all duration-500 ease-in-out"
			>
