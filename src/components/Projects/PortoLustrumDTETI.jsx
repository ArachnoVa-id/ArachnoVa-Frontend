    ...
    <section className="w-full lg:aspect-[1920/748] max-lg:aspect-[430/552] flex flex-col items-center justify-center bg-[#F1F4F4] overflow-hidden ">
      ...
      <div className="flex max-lg:hidden ">
        <div className="w-[20.0rem] text-black pt-[2.0rem] mr-[5.0rem]">
          <h1 className="text-[2.0rem] font-SourceSansProBold">Lustrum DTETI</h1>
        ...
        >
          ...
          <Image
            ...
            className="absolute w-[8.0rem] aspect-[245/495] rounded-[1.0rem] -bottom-[2.0rem] right-[0.000rem] shadow-2xl "
            draggable="false"
            width={1000}
            height={1000}
          />
