    ...
    <section className="w-full lg:aspect-[1920/748] max-lg:aspect-[430/552] flex flex-col items-center justify-center bg-neutral-a overflow-hidden">
      ...
      <div className="flex max-lg:hidden">
        ...
        <div className="w-[3.2rem] text-black pt-[0.32rem] ml-[0.8rem]">
          ...
          <p className="text-[0.5rem]/[0.39rem] font-SourceSansProSemibold text-neutral-e text-right">
          ...
          <div className="flex justify-end">
            <a href="https://www.electionftugm.web.id/" className="w-[0.75rem] mt-[0.2rem] bg-gradient-to-r rounded-[0.2rem] text-[0.5rem] aspect-[90/48] from-[#1AB0C8] to-[#179FB5] font-InterBold text-white flex justify-center items-center hover:translate-y-[-1px] transition-all duration-500 ease-in-out ">
              Source
            </a>
          </div>
        </div>
      ...
      <div className="flex flex-col justify-center items-center lg:hidden gap-y-[0.96rem]">
        ...
        >
          <Image
            alt="Content Prototype"
            src="/image/OurProducts/KPUFTHero.svg"
            className=" w-[12.1rem] aspect-[669/376] rounded-xl border-white border-[0.05rem] shadow-2xl "
            draggable="false"
            width={1000}
            height={1000}
          />
        ...
        <a href="https://www.electionftugm.web.id/" className="w-[14.4rem] h-[1.6rem] mt-[0.2rem] text-[0.5rem] bg-gradient-to-r from-[#1AB0C8] to-[#179FB5] font-InterBold text-white rounded-md  flex justify-center items-center hover:translate-y-[-1px] transition-all duration-500 ease-in-out ">
          Source
        </a>
      </div>
    </section>
