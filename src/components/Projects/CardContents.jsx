...
const CardContents = ({ title, description, image, imageMobile }) => {
  ...
  return (
    <section>
      <div className="relative bg-gradient-to-r from-teal to-tealDark  mx-[5vw] rounded-[2vw] w-[70.260vw] aspect-[1349/576] flex flex-col justify-end items-center mt-[13vw] max-lg:hidden">
        <div
        ...
        <div className="font-SourceSansProBold text-[2.083vw] text-surface">{title}</div>
        <div className="w-[60vw] text-center text-[1.042vw] font-SourceSansProSemibold mb-[3vw] text-surface ">
          {description}
        </div>
      ...
      {/* Mobile */}
      <div className="relative bg-gradient-to-r from-teal to-tealDark rounded-2xl aspect-[344/304] w-[70.442vw] mx-[10vw]  flex flex-col justify-end items-center mt-[30vw] lg:hidden">
        <div
        ...
        <div className="font-SourceSansProBold mb-[2vw] text-[5.581vw] text-surface">
          {title}
        </div>
        <div className="w-[60vw] text-[3vw] text-center font-SourceSansProSemibold mb-[5vw] text-surface">
          {description}
        </div>
