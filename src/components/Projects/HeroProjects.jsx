...
const HeroProjects = () => {
  return (
    <section className="w-full lg:aspect-[1920/1312] max-lg:aspect-[430/825] flex flex-col items-center relative justify-center aspect-[1920/1312] bg-neutral-a overflow-hidden ">
      ...
      <div className="text-black flex flex-col justify-center items-center  text-[0.5rem]/[42px] max-lg:hidden z-[2] mb-[0.42rem] " data-aos="fade-down">
      ...
      {/* Mobile */}
      <div className="text-black flex flex-col justify-center items-center text-[0.64rem]/[115px] mb-[1.6rem] lg:hidden z-[2] mt-[3.9rem]" data-aos="fade-down">
